...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        val MIGRATION_2_3 = object : Migration(2, 3) {
            override fun migrate(database: SupportSQLiteDatabase) {
                database.execSQL("ALTER TABLE recordings ADD COLUMN aiTitle TEXT DEFAULT NULL")
                database.execSQL("ALTER TABLE recordings ADD COLUMN aiTitleTime INTEGER DEFAULT NULL")
            }
        }
